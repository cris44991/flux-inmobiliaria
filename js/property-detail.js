...
(function() {
  ...
  const allProperties = [
    ...
    { id: 'depa-vina', tipo: 'departamento', title: 'Departamento Viña del Mar', price: 138000000, priceUF: '3.520', location: 'Viña del Mar, Valparaíso', beds: 3, baths: 2, area: '79 m²', builtArea: '72 m²', image: '../img/propiedades/departamentoviñadelmar.jpg', badge: 'Nueva', description: 'Departamento moderno con vista al mar en Viña del Mar. Ideal para inversión.' },
    { id: 'terreno-concepcion', tipo: 'terreno', title: 'Terreno 720 m²', price: 95000000, priceUF: '2.400', location: 'Concepción, Biobío', beds: 0, baths: 0, area: '720 m²', builtArea: '0 m²', image: '../img/propiedades/terreno.jpg', badge: null, description: 'Terreno amplio y plano, ideal para proyecto inmobiliario de gran escala.' },
    { id: 'casa-nunoa', tipo: 'casa', title: 'Casa 3D / 2B', price: 195000000, priceUF: '4.900', location: 'Ñuñoa, Santiago', beds: 3, baths: 2, area: '160 m²', builtArea: '140 m²', image: '../img/propiedades/casalascondes.jpg', badge: null, description: 'Casa cómoda en sector tranquilo de Ñuñoa, cerca de servicios.' },
    { id: 'depa-serena', tipo: 'departamento', title: 'Departamento 2D / 1B', price: 85000000, priceUF: '2.100', location: 'La Serena, Coquimbo', beds: 2, baths: 1, area: '65 m²', builtArea: '60 m²', image: '../img/propiedades/departamentoviñadelmar.jpg', badge: null, description: 'Departamento económico en La Serena, cerca del centro comercial.' },
    { id: 'casa-providencia', tipo: 'casa', title: 'Casa en Providencia', price: 420000000, priceUF: '10.800', location: 'Providencia, Santiago', beds: 4, baths: 3, area: '280 m²', builtArea: '250 m²', image: '../img/propiedades/casalascondes.jpg', badge: null, description: 'Residencia de lujo en zona exclusiva de Providencia, con acceso a parques.' },
    { id: 'depa-estacion', tipo: 'departamento', title: 'Departamento Centro', price: 120000000, priceUF: '3.050', location: 'Centro, Santiago', beds: 2, baths: 1, area: '72 m²', builtArea: '68 m²', image: '../img/propiedades/departamentoviñadelmar.jpg', badge: null, description: 'Departamento céntrico, ideal para inversión o vivir cerca de todo.' },
    { id: 'terreno-macul', tipo: 'terreno', title: 'Terreno en Macul', price: 75000000, priceUF: '1.900', location: 'Macul, Santiago', beds: 0, baths: 0, area: '500 m²', builtArea: '0 m²', image: '../img/propiedades/terreno.jpg', badge: null, description: 'Terreno en zona de desarrollo inmobiliario, con buen acceso.' }
  ];
